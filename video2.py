...
# Video writer setup
fps = 60  # Frame rate
video_filename = "animation_with_audio.mp4"
audio_clip = AudioFileClip(audio_filename)
audio_clip = audio_clip.volumex(0.8)  # Reduce volume to 80%
video_writer = FFMPEG_VideoWriter(video_filename, (width, height), fps=fps, codec="libx264", preset='medium', audiofile=audio_filename, threads=None, ffmpeg_params=['-pix_fmt', 'yuv420p'])
